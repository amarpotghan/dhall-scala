...
0. Do not make more than one logical change per commit. We insist on atomic commits.
...
0. The commit message should obey the following formatting guidelines:
  ...
  - Append `(#issueNumber)` at the end of your subject line.
